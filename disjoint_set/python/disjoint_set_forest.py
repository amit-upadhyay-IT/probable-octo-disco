...
class DisjointSet:
    ...
    def union(self, data1, data2):
        ...
        if parent1.rank >= parent2.rank:
            ...
            parent1.rank = 1 + parent1.rank if parent1.rank == parent2.rank else parent1.rank
        ...
        # now we need to see of both of them belong to same set or not
